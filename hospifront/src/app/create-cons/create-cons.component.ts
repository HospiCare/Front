      ...
      <div class="two-column-layout">
        ...
        <div class="column">
          ...
          <div class="card">
            ...
            <div class="ordonnance-form">
              ...
              <button
                ...
                [disabled]="
                  ...
                  !doseInput.valid ||
                  !dureeInput.valid ||
                  nouveauMedicament.dose <= 0 ||
                  nouveauMedicament.duree <= 0
                "
              >
                Ajouter
              </button>
            ...
            <table class="table">
              ...
              <tbody>
                @for (medicament of medicaments; track medicament.nom; let i =
                $index) {
                <tr [class.selected]="selectedRow === i" (click)="selectRow(i)">
            ...
            <div class="infirmier-section">
              ...
              <select [(ngModel)]="infirmierr" class="select-input">
                <option value="">Sélectionner un infirmier</option>
                @for (infirmier of infermiers ; track infirmier) {
          ...
          <div class="card">
            ...
            <div class="select-container">
              <select [(ngModel)]="laboratinn" class="select-input">
                <option value="">Sélectionner un laboratin</option>
                @for (laboratin of laboratins ; track laboratin) {
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="select-container">
              <select [(ngModel)]="radiologuee" class="select-input">
                <option value="">Sélectionner un radiologue</option>
                @for (radiologue of radiologues ; track radiologue) {
          ...
          <div class="actions">
            <button class="button" (click)="enregistrerConsultation()">
              Enregistrer
            </button>
          </div>
        </div>
...
export class CreateConsComponent {
  //labos .radios et infirmiers sont des listes de noms
infermiers: string[] | null = null; //hna nsh9o la list ta3 inf,labo,radio ;
laboratins: string[]   | null = null; //hna nsh9o la list ta3 inf,labo,radio ;
radiologues: string[]  | null = null; //hna nsh9o la list ta3 inf,labo,radio ;
  ...
  enregistrerConsultation() {
    ...
    const consultation: Consultation = {
      ...
      resume: this.resume,
      soins: this.Soins,
      laboratin: this.laboratinn,
      radiologue: this.radiologuee,
      infirmier: this.infirmierr,
      frais: this.frais,
    };
   // hna ysra post request l backend
